...
func ParseOptions() *Options {
	...
	flagSet.CreateGroup("configs", "Configurations",
		...
		flagSet.Var(&options.Allow, "allow", "allowed list of IPList/CIDR's to process (file or comma separated)"),
		flagSet.Var(&options.Deny, "deny", "denied list of IPList/CIDR's to process (file or comma separated)"),
